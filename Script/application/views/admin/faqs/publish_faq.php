<div class="tile mb30">
    ...
    <div class="tile-content">
        <div class="text-center mt50 mb50">
            <div class="mb15"><img src="<?= base_url();?>assets/images/unblock-faq.svg" alt="<?= $title; ?>"></div>
            <p><?= $this->lang->line("text_publish_faq_info"); ?></p>
            <p>
                <button class="btn btn-success btn-lg btn-oval" id="confirmPublishButton" data-id="<?= $faq_id; ?>"><i class="feather icon-unlock"></i> <?= $this->lang->line("text_publish"); ?></button>

<div class="tile mb30">
    ...
    <div class="tile-content">
        <div class="text-center mt50 mb50">
            <div class="mb15"><img src="<?= base_url();?>assets/images/block-faq.svg" alt="<?= $title; ?><"></div>
            <p><?= $this->lang->line("text_unpublish_faq_info"); ?></p>
            <p>
                <button class="btn btn-warning btn-lg btn-oval" id="confirmUnublishButton" data-id="<?= $faq_id; ?>"><i class="feather icon-lock"></i> <?= $this->lang->line("text_unpublish"); ?></button>

<div class="tile mb30">
    ...
    <div class="tile-content">
        <div class="text-center mt50 mb50">
            <div class="mb15"><img src="<?= base_url();?>assets/images/delete-user.svg" alt="<?= $title; ?>"></div>
            <p><?= $this->lang->line("text_delete_user_info"); ?></p>
            <p>
                <button class="btn btn-danger btn-lg btn-oval" id="confirmDeleteButton" data-id="<?= $user_id; ?>"><i class="feather icon-trash-2"></i> <?= $this->lang->line("text_delete"); ?></button>

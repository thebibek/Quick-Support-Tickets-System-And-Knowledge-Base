<div class="tile mb30">
    ...
    <div class="tile-content">
        <div class="text-center mt50 mb50">
            ...
            <p><?= $this->lang->line("text_block_user_info"); ?></p>
            <p>
                <button class="btn btn-warning btn-lg btn-oval" id="confirmBlockButton" data-id="<?= $user_id; ?>"><i class="feather icon-user-x"></i> <?= $this->lang->line("text_block"); ?></button>

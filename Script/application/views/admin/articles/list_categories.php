<div class="app-title">
    <div class="title-holder">
        <h1><i class="feather icon-briefcase"></i> <?= $this->lang->line("text_article_categories"); ?></h1>
        <p><?= $this->lang->line("text_article_categories_subtitle"); ?></p>
    </div>
    <ul class="app-breadcrumb breadcrumb">
        <li class="breadcrumb-item"><a href="<?= base_url('admin/'); ?>"><i class="feather icon-home"></i></a></li>
        <li class="breadcrumb-item"><a href="<?= base_url('admin/articles'); ?>"><?= $this->lang->line("text_articles"); ?></a></li>
        <li class="breadcrumb-item"><?= $this->lang->line("text_article_categories"); ?></li>
    </ul>
</div>
<div class="row">
    <div class="col-12">
        <div class="tile mb30">
            <div class="tile-title-w-btn">
                <div class="title">
                    <h3><i class="feather icon-briefcase"></i> <?= $this->lang->line("text_article_categories"); ?></h3>
                </div>
                <?php if($permissions['add_article_category']==TRUE) { ?>
            ...
            <div id="categoryTab" class="tile-tabs">
                <ul>
                    ...
                    <?php } ?>
                    <?php if($permissions['article_category_ordering']==TRUE) { ?>
